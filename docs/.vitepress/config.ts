  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/skills/chandao/': [
        {
          text: 'chandao',
          items: [{ text: '概述', link: '/skills/chandao/' }],
        },
      ],
      '/skills/fnnas-docs/': [
        {
          text: 'fnnas-docs',
          items: [{ text: '概述', link: '/skills/fnnas-docs/' }],
        },
      ],
      '/skills/halo/': [
        {
          text: 'halo',
          items: [{ text: '概述', link: '/skills/halo/' }],
        },
      ],
      '/skills/memos/': [
        {
          text: 'memos',
          items: [{ text: '概述', link: '/skills/memos/' }],
        },
      ],
      '/skills/openlist/': [
        {
          text: 'openlist',
          items: [{ text: '概述', link: '/skills/openlist/' }],
        },
      ],
      '/cli/': [
        {
