...
代理根据用户意图选择对应模块和操作。更新前先读取当前数据，创建时一次性传入用户已提供的全部参数；删除等破坏性操作需要先确认。详细参数和流程见左侧对应文档。
...
常见意图包括“查看项目”“创建需求”“开始任务”“关闭缺陷”“查看测试用例”等，技能会将其转换为对应脚本命令。完整命令、参数和接口差异见[命令文档](commands-project)与[接口参考](api-reference)。
