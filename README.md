...
| Skill | Description |
|-------|-------------|
| [antfu](skills/antfu) | Anthony Fu 的 app/library 项目偏好（eslint, pnpm, vitest, vue 等）- Tnnevol 修改 |
...
本 Fork 基于 [antfu/skills](https://github.com/antfu/skills)，由 [Anthony Fu](https://github.com/antfu) 创建。
