...
const actionMap = {
  ...
  "upload-attachment": (a) => attachment.actionAttachmentUpload(api, BASE_URL, a),
  "delete-attachment": (a) => attachment.actionAttachmentDelete(api, BASE_URL, a),
  "batch-delete-attachment": (a) => attachment.actionAttachmentBatchDelete(api, BASE_URL, a),
